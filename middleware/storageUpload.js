...
const createFileFilter = (allowedMimePatterns, allowedExtensions) => {
  return (req, file, cb) => {
    ...
    // Both checks are required. An extension alone is attacker-controlled and a
    // MIME type alone is unreliable; validating the pair prevents disguised
    // executable/content uploads from reaching public object storage.
